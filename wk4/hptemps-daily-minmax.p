...
set output "minmax-daily-temps.eps"
set title "Daily minimum and maximum temperatures of processor zone on host lost24"
plot "max-daily-temps.tsv" using 1:3 title 'CPU #1 max' with linespoints, "min-daily-temps.tsv" using 1:3 title 'CPU #1 min' with linespoints